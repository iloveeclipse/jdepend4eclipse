...
public class SupportPanel {
    ...
    static void createSupportLinks(Composite defPanel) {
        ...
        link.addListener (SWT.Selection, new Listener () {
            ...
            public void handleEvent(Event event) {
                handleUrlClick("https://github.com/iloveeclipse/plugins/wiki/JDepend4Eclipse");
            }
        });
        ...
        link.addListener (SWT.Selection, new Listener () {
            @Override
            public void handleEvent(Event event) {
                handleUrlClick("https://github.com/iloveeclipse/jdepend4eclipse/issues");
            }
        });
    ...
    private static void handleUrlClick(final String urlStr) {
        try {
            ...
            JDepend4EclipsePlugin.logError(e, "Failed to open url " + urlStr);
